...
const fixTypo = artists[8].name.split(" ");
fixTypo.splice(1, 2);
fixTypo.push("Van Gogh");
artists[8].name = fixTypo.join(" ");
...
function getArtistByIndex(array, index) {
  ...
  /******************************************************************ALL CODE FROM TASK 4 AND DOWN WAS COMPLETED AFTER SPRINT HOURS**********************************************************************************/
...
function get20s(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    let getDates = data[i].years.split(" - ");
    if (getDates >= "1900" && getDates < "2000") {
      cent20s.push(data[i].name);
    };
  };
  return cent20s;
};
 ...
 * 
 * Note that sucessfully invoking this function multiple times without refreshing your browser will continuously remove artists from the array until there are none left. If you refresh your browser, 
 * the data will reset.  
*/
...
let myObject = {                                                      
      ...
      "genre": "Web Design",
      "nationality": "White",
      "bio": "I like developing websites. I like working with technology. I love working on project that can change the world."
    };
